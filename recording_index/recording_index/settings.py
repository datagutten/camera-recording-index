"""
Django settings for recording_index project.
...
ROOT_URLCONF = "recording_index.urls"
...
WSGI_APPLICATION = "recording_index.wsgi.application"
...
CAMERA_HEIGHT = int(os.getenv('CAMERA_HEIGHT', 30))
STREAM_URL = os.getenv('STREAM_URL', '/video/')
VIDEO_ROOT = os.getenv('VIDEO_ROOT', '/video/')
SECONDS_PER_PIXEL = os.getenv('SECONDS_PER_PIXEL', 60)
